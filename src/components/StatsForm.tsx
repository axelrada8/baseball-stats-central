...
export default function StatsForm({ stats, onStatsChange, onDateChange, language, translations }: StatsFormProps) {
  ...
  return (
    <Card className="mb-6 bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row items-center mb-6 justify-end">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
          {Object.entries(stats).filter(([key]) => key !== 'date').map(([key, value]) => (
