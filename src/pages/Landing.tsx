...
const Landing = () => {
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-[#0a0a0a] text-white relative overflow-hidden">
      ...
      >
        <div className="flex items-center justify-center gap-3 cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
        ...
        <div className="hidden lg:flex items-center ml-12 gap-6">
          <Button 
            variant="ghost" 
            className="text-white/60 hover:text-white hover:bg-white/5 font-light tracking-wider"
              ...
              <Card className="bg-white/[0.02] border-white/10 relative scale-105 flex flex-col">
                ...
                <CardContent className="p-8 space-y-8 flex-1 flex flex-col">
                  ...
                  <Button 
                    ...
                    onClick={() => handlePlanSelection('premium', isAnnual ? 'yearly' : 'monthly')}
                  >
                    Subscribe Now
                  </Button>
                </CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-sm font-light text-white/40 leading-relaxed">
                Advanced baseball analytics for the modern game.
              </p>
            </div>
